...
export default function LoginPage() {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    if (error) {
      ...
      // 2. KRİTİK DÜZELTME: 
      // Next.js router bazen Middleware çerezlerini anında yakalayamıyor.
      // window.location.href kullanarak sayfayı sert yönlendirme ile yüklüyoruz.
      // Bu sayede "Doğrulanıyor" döngüsü kırılır ve Dashboard açılır.
